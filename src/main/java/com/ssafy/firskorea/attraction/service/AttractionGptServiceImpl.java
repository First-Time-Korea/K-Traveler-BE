...
public class AttractionGptServiceImpl implements AttractionGptService {
    ...
    @Override
    @Transactional
    public AttractionDto prompt(Map<String, String> map) throws SQLException {
        AttractionDto attractionDto = attractionMapper.getAttractionByContentId(map);
        CompletionRequestDto completionRequestDto = new CompletionRequestDto(
                "gpt-3.5-turbo", List.of(
                new CompletionRequestDto.Message("system",
